...
\item The top 100 keywords generated provided from \citeapos{1}. The full list of words used in \citeapos{1}'s keyword adjacency stoplist was not available, so we are using what was provided in the paper to compare against our generated stoplist. 
\end{enumerate}  
...
\begin{tabular}{>{\raggedright\arraybackslash}p{2.9cm}c c c c c c c }
	...
	RAKE                                     &  \\
	\makecell{KA stoplist \\(top 100 words)}    &                    &      &                  &      &           &        &           \\
	\makecell{KA stoplist \\(generated)}        &                    &      &                  &      &           &        &           \\
	Fox stoplist                             &                    &      &                  &      &           &        &           \\ \hline
	TextRank                                 &  \\
	\makecell{Undirected, co-occ. \\window = 2} &                    &      &                  &      &           &        &           \\
	\makecell{Undirected, co-occ. \\window = 3} &                    &      &                  &      &           &        &           \\ \hline
\end{tabular}
} 
