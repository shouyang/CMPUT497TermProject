...
def get_TextRank_keywords(sample, window = 2, T_DEMON = 3):
    keywords.WINDOW_SIZE = window
    return keywords.keywords(sample.abstract, ratio = 1 / T_DEMON, split= True)
...
for sample in abstracts:
    ...
    # Generate Output
    # print("Abstract:", sample.abstract[:75])
    ...
    # print(get_recall(rake_estimate_keywords,actual_keywords), get_precision(rake_estimate_keywords, actual_keywords))
    # print("--")
